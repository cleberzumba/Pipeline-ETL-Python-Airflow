...
input = '/home/dmpm/Projeto3/entrada/dados_hoteis.json'
...
def func_insert_dimensions():
    ...
    # Carrega o arquivo
    dados_dim_1 = pd.read_csv('/home/dmpm/Projeto3/stage/resultado2.csv', index_col = False, delimiter = ',')
    dados_dim_1.head()
    ...
    # Carrega o arquivo
    dados_dim_2 = pd.read_csv('/home/dmpm/Projeto3/stage/resultado3.csv', index_col = False, delimiter = ',')
    dados_dim_2.head()
    ...
    # Carrega o arquivo
    dados_dim_3 = pd.read_csv('/home/dmpm/Projeto3/stage/resultado4.csv', index_col = False, delimiter = ',')
    dados_dim_3.head()
...
with DAG(dag_id = 'DAG_Projeto3', start_date = pendulum.datetime(2022, 1, 1, tz = "UTC"), schedule_interval = '@Daily', catchup = False) as dag:
    ...
    task2_extrai_dados = PythonOperator(
        ...
        op_kwargs = {'path': '/home/dmpm/Projeto3/stage/resultado1.csv'},
        dag = dag
    )
    ...
    task3_prices_range_position = PythonOperator(
        ...
        op_kwargs = {'path': '/home/dmpm/Projeto3/stage/resultado2.csv'},
        dag = dag
    )
    ...
    task4_hotel_award_rating = PythonOperator(
        ...
        op_kwargs = {'path': '/home/dmpm/Projeto3/stage/resultado3.csv'},
        dag=dag
    )
    ...
    task5_reviews_class_rating = PythonOperator(
        ...
        op_kwargs = {'path': '/home/dmpm/Projeto3/stage/resultado4.csv'},
        dag = dag
    )
